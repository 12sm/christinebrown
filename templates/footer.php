    ...
    <div class="row">
      <div class="col-xs-5 social-nav">
        <div id="social-float" class="row">
          ...
          <li class="menu-"><a href="https://soundcloud.com/christine-brown-piano" target="_blank"><img src="/assets/img/soundcloud.png" onmouseover="this.src='/assets/img/soundcloud.png'" onmouseout="this.src='/assets/img/soundcloud.png'"></i></a></li> 
