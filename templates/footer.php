    ...
    <div class="row">
      ...
      <div class="col-xs-5 stores-nav">
        <div id="social-float" class="row">
          ...
          <ul id="menu-social-navigation" class="">
          <li class="menu-"><a href="https://itunes.apple.com/artist/christine-brown/id28052587?forceArtistPage=1" target="_blank"><img img class="img-responsive" src="/assets/img/apple.png" onmouseover="this.src='/assets/img/apple-active.png'" onmouseout="this.src='/assets/img/apple.png'"></a></i></a></li>
